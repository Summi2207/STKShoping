...
import com.stk.STK_Shopping.ui.my_cart.MyCartFragment;
import com.stk.STK_Shopping.ui.my_mall.MyMallFragment;
import com.stk.STK_Shopping.ui.my_orders.MyOrdersFragment;
import com.stk.STK_Shopping.ui.my_rewards.MyRewardsFragment;
import com.stk.STK_Shopping.ui.my_wishlist.MyWishlistFragment;
                        ...
                        if(task.isSuccessful()){
                            for(QueryDocumentSnapshot documentSnapshot : task.getResult()){
                                ...
                                if((long)documentSnapshot.get("view_type") == 0){
                                    ...
                                    lists.get(index).add(new MyMallModel(1,documentSnapshot.get("strip_ad_banner").toString(),documentSnapshot.get("background").toString()));
                                    ...
                                    lists.get(index).add(new MyMallModel(3,documentSnapshot.get("layout_title").toString(),documentSnapshot.get("layout_background").toString(),gridProductScrollModelList));
